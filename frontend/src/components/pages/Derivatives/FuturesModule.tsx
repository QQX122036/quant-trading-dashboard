  ...
  const contracts: FuturesContract[] = [
    {
      ...
      subContract: 'IF2509',
      latestPrice: 3850.2,
      prevSettlement: 3832.0,
      change: 18.2,
      changePct: 0.47,
      volume: 120543,
      openInterest: 234567,
      spotPrice: 3835.0,
      nearMonthPremium: 15.2,
      farMonthPremium: 8.4,
    },
    {
      symbol: 'IC',
      ...
      subContract: 'IC2509',
      latestPrice: 5620.4,
      prevSettlement: 5580.0,
      change: 40.4,
      changePct: 0.72,
      volume: 87654,
      openInterest: 189432,
      spotPrice: 5590.0,
      nearMonthPremium: 30.4,
      farMonthPremium: 15.6,
    },
    {
      symbol: 'IH',
      name: '上证50期货',
      ...
      subContract: 'IH2509',
      latestPrice: 2680.5,
      prevSettlement: 2665.0,
      change: 15.5,
      changePct: 0.58,
      volume: 54321,
      openInterest: 98765,
      spotPrice: 2670.0,
      nearMonthPremium: 10.5,
      farMonthPremium: 5.2,
    },
    {
      symbol: 'IM',
      ...
      subContract: 'IM2509',
      latestPrice: 6240.8,
      prevSettlement: 6190.0,
      change: 50.8,
      changePct: 0.82,
      volume: 65432,
      openInterest: 145678,
      spotPrice: 6200.0,
      nearMonthPremium: 40.8,
      farMonthPremium: 22.3,
    },
    {
      symbol: 'T',
      name: '10年国债期货',
      ...
      subContract: 'T2509',
      latestPrice: 106.52,
      prevSettlement: 106.48,
      change: 0.04,
      changePct: 0.038,
      volume: 32145,
      openInterest: 87654,
      spotPrice: 106.4,
      nearMonthPremium: 0.12,
      farMonthPremium: 0.085,
    },
    {
      symbol: 'RU',
      name: '橡胶期货',
    ...
    },
    {
      ...
      subContract: 'CU2509',
      latestPrice: 76500,
      prevSettlement: 76200,
      change: 300,
      changePct: 0.39,
      volume: 34567,
      openInterest: 43210,
      spotPrice: 76300,
      nearMonthPremium: 200,
      farMonthPremium: 120,
    },
    {
      symbol: 'AU',
      ...
      subContract: 'AU2509',
      latestPrice: 682.5,
      prevSettlement: 680.0,
      change: 2.5,
      changePct: 0.37,
      volume: 23456,
      openInterest: 34567,
      spotPrice: 681.0,
      nearMonthPremium: 1.5,
      farMonthPremium: 0.8,
    },
  ];
  return contracts;
          ...
          {(c) => (
            ...
            >
              ...
              <div class="text-sm font-mono font-bold text-white">
                {c.latestPrice.toFixed(c.symbol === 'T' || c.symbol === 'AU' ? 3 : 2)}
              </div>
              <div class="flex items-center gap-2 mt-1">
                <span
                  class={`text-xs font-mono ${c.change >= 0 ? 'text-red-400' : 'text-green-400'}`}
                >
                  {premiumPrefix(c.change)}
                  {c.change.toFixed(2)} ({premiumPrefix(c.changePct)}
        ...
        <div class="flex-1 flex flex-col bg-[#111827]/80 rounded-lg border border-white/10">
          <div class="px-4 py-2 border-b border-white/10 flex items-center justify-between">
            <span class="text-xs font-bold">
              跨期价差 ({selectedContract().mainContract} - {selectedContract().subContract})
            </span>
          ...
          <div class="bg-[#111827]/80 rounded-lg border border-white/10 p-3">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span
                  class={`text-xs font-mono font-bold ${premiumColor(selectedContract().nearMonthPremium)}`}
                >
                  {premiumPrefix(selectedContract().nearMonthPremium)}
                  {selectedContract().nearMonthPremium.toFixed(2)}
                </span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-400">远月-近月</span>
                <span
                  class={`text-xs font-mono font-bold ${premiumColor(selectedContract().farMonthPremium)}`}
                >
                  {premiumPrefix(selectedContract().farMonthPremium)}
                  {selectedContract().farMonthPremium.toFixed(2)}
                </span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-400">现货价格</span>
                <span class="text-xs font-mono text-white">
                  {selectedContract().spotPrice.toFixed(2)}
                </span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-400">年化升水率</span>
                <span
                  class={`text-xs font-mono font-bold ${premiumColor((selectedContract().nearMonthPremium / selectedContract().spotPrice) * 12)}`}
                >
                  {(
                    (selectedContract().nearMonthPremium / selectedContract().spotPrice) *
                    12 *
                    100
                  ).toFixed(2)}
                  %
